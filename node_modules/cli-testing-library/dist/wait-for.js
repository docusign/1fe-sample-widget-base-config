...
function waitFor(callback, {
  instance = (0, _helpers.getCurrentInstance)(),
  timeout = (0, _config.getConfig)().asyncUtilTimeout,
  showOriginalStackTrace = (0, _config.getConfig)().showOriginalStackTrace,
  stackTraceError,
  interval = 50,
  onTimeout = error => {
    error.message = (0, _config.getConfig)().getInstanceError(error.message, instance).message;
    return error;
  }
}) {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    if (usingJestFakeTimers) {
      ...
      observer = new _mutationObserver.MutationObserver(checkRealTimersCallback);
      observer.observe();
      checkCallback();
    }
