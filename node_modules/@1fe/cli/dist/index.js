...
async function getTargetLayer(environment) {
  ...
  const browsersListRules = (await getDynamicConfigs(environment)).platform.browserslistConfig.join();
...
var getKnownUris = lodash.memoize(async (environment) => {
  ...
  const tempUrl = "https://cdn.jsdelivr.net/gh/docusign/mock-cdn-assets/integration/widgets/";
  return {
