(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var LogTierV1EventProcessor = /** @class */ (function () {
        function LogTierV1EventProcessor(_a) {
            var dispatcher = _a.dispatcher, closingDispatcher = _a.closingDispatcher, _b = _a.flushInterval, flushInterval = _b === void 0 ? eventProcessor.DEFAULT_FLUSH_INTERVAL : _b, _c = _a.batchSize, batchSize = _c === void 0 ? eventProcessor.DEFAULT_BATCH_SIZE : _c, notificationCenter = _a.notificationCenter;
            ...
            this.queue = eventProcessor.getQueue(batchSize, flushInterval, events.areEventContextsEqual, this.drainQueue.bind(this, false), this.drainQueue.bind(this, true));
        }
    ...
    */
    ...
    var BROWSER_CLIENT_VERSION = '4.10.1';
    var NODE_CLIENT_VERSION = '4.10.1';
    ...
    */
    ...
    var createInstance = function (config) {
        try {
            ...
            if (!config.eventDispatcher && !closingDispatcher && window.navigator && 'sendBeacon' in window.navigator) {
                closingDispatcher = eventDispatcher$1;
            }
    ...
    var index_browser$1 = {
        ...
        eventDispatcher: defaultEventDispatcher,
        sendBeaconEventDispatcher: eventDispatcher$1,
        enums: enums,
        setLogger: lib_5$1,
        setLogLevel: lib_3$1,
    ...
    exports.sendBeaconEventDispatcher = eventDispatcher$1;
