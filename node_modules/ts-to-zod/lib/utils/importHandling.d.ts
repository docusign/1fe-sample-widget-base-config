 ...
 */
export declare function getImportIdentifiers(node: ts.ImportDeclaration): ImportIdentifier[];
export declare function getSingleImportIdentierForNode(node: ts.ImportDeclaration, identifier: string): ImportIdentifier | undefined;
/**
 ...
 */
export declare function createImportNode(identifiers: ImportIdentifier[], path: string): ts.ImportDeclaration;
